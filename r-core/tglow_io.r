...
tglow.build.img.index <- function(path, pattern.group, pattern.file=".*_composite_.*.png", pattern.filter=".*_composite_segmented_.*.png", pattern.field=".*_(f\\d\\d)\\..*") {
...
tglow.read.imgs <- function(data, cell.subset, img.index, format="png", window=75,
